...
int main(){
	...
	string seq1(randomSeq(10000)),seq2(randomSeq(10000)),align1,align2;
	//~ cout<<seq1<<endl;
	//~ cout<<seq2<<endl;
	...
	//we compare the sketches
	uint32_t res3(sketchHammingComparison(sketch1,sketch2));
	uint32_t res4(sketchComparison(sketch1,sketch2));
